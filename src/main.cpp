...
void printHelp() {
    printf("usage: console_sodoku [OPTIONS] \n\n"
                           "Play Sudoku in the terminal.\n\n"
                           "Optional args:\n"
                           "-easy            Playing sudoku for noob\n"
                           "-medium          Playing sudoku for know-how-to-play-player\n"
                           "-hard            Playing sudoku for proplayer\n"
